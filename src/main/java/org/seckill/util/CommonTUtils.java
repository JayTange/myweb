...
public class CommonTUtils {
    ...
    private static Logger logger = LoggerFactory.getLogger(CommonTUtils.class);
     ...
     * 获取文件所在目录
     */
    private static String location = CommonTUtils.class.getClassLoader().getResource("").getPath();
...
//            默认是classPath路径
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (CommonTUtils.class) {
            if (newDataSource == null) {
                Properties properties = CommonTUtils.getPropFromFile("application-jdbc.properties");
    ...
    public static String getUplodFilePath() {
        String path = CommonTUtils.class.getProtectionDomain().getCodeSource().getLocation().getPath();
